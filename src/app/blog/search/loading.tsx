        ...
        <main className='lg:w-3/4 order-1 lg:order-2'>
          <div className='space-y-8'>
            <div className='text-center'>
              <div className='h-8 w-48 bg-gray-200 dark:bg-gray-700 rounded-lg mx-auto mb-4 animate-pulse' />
              <div className='h-4 w-64 bg-gray-200 dark:bg-gray-700 rounded-lg mx-auto animate-pulse' />
            </div>
            <div className='space-y-8'>
              {[...Array(3)].map((_, i) => (
                <div
