  ...
  return (
    <div className='flex gap-4'>
      <button
        ...
        className='text-blue-400 hover:text-blue-600 bg-transparent border-0 p-0 cursor-pointer'
      ...
      <button
        ...
        className='text-blue-600 hover:text-blue-800 bg-transparent border-0 p-0 cursor-pointer'
