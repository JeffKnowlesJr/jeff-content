...
export default function ProjectCard({
  ...
  return (
    <Link href={`/projects/${slug}`} className='group block h-full'>
      <div className='bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:-translate-y-2 cursor-pointer h-full flex flex-col'>
        <article
          key={id}
